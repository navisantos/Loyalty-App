...
$(document).ready(function(){
	...
	var settings = {
	  "async": true,
	  "crossDomain": true,
	  "url": "https://ucf3-fap0185-fa-ext.oracledemos.com/crmRestApi/resources/latest/loyaltyMembers/300000157820432",
	  "method": "GET",
	  "headers": {
...
$(document).ready(function(){
    //$("button").click(function(){
		var vouchers = {
		  "async": true,
		  "crossDomain": true,
		  "url": "https://ucf3-fap0185-fa-ext.oracledemos.com/crmRestApi/resources/latest/loyaltyMembers/300000157820432/child/MemberVouchers",
		  "method": "GET",
		  "headers": {
			"authorization": "Basic am9obi5kdW5iYXI6dUtNOTM3NTQ="
		  }
